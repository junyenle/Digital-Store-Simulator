...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Mar 20 23:11:55 2017
# Project:  hw5.pro
# Template: app
...
compiler_moc_header_make_all: moc_datastore.cpp moc_main_window.cpp moc_mydatastore.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_datastore.cpp moc_main_window.cpp moc_mydatastore.cpp
moc_datastore.cpp: product.h \
		user.h \
		review.h \
		datastore.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) datastore.h -o moc_datastore.cpp

moc_main_window.cpp: user.h \
		main_window.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) main_window.h -o moc_main_window.cpp

moc_mydatastore.cpp: product.h \
		book.h \
		util.h \
		movie.h \
		clothing.h \
		...
		review.h \
		mydatastore.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) mydatastore.h -o moc_mydatastore.cpp
...
moc_mydatastore.o: moc_mydatastore.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mydatastore.o moc_mydatastore.cpp
