...
{
    string ptype = "book";
    Product* bookproduct = new Book(ptype, prodName_, price_, qty_, isbn_, author_);
    return bookproduct;
}
...
Product* ProductClothingParser::makeProduct()
{
    ...
    string ptype = "clothing";
    Product* clothingproduct = new Clothing(ptype, prodName_, price_, qty_, size_, brand_);   
...
{
    string ptype = "movie";
    Product* movieproduct = new Movie(ptype, prodName_, price_, qty_, genre_, rating_);   
    return movieproduct;
